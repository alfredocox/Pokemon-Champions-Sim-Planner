// Generated by tools/build-project-roadmap.mjs. Do not edit.
(function(root) {
  ...
  "milestones": [
    {
      "id": "simulation-truth",
      "title": "Simulation And Replay Truth",
      "status": "blocked",
      "owner": "Mechanics Engineer and independent mechanics reviewer",
      "legacy": [
        "M1",
        "M9"
      ],
      ...
      "evidence": [
        "poke-sim/reports/showdown_reference_validation_2026-08-30.md",
        "poke-sim/reports/visual_replay_audit_2026-08-30.md",
    ...
    {
      "id": "regulation-source-truth",
      "title": "Regulations And Source Truth",
      "status": "blocked",
      "owner": "Source/Data Engineer and human data approver",
      "legacy": [
        "M1"
      ],
      "depends_on": [],
      ...
      "evidence": [
        "docs/release/REGULATION_WATCH_2026-08-30.md",
        "poke-sim/docs/REGULATION_CONTEXT_AND_ELIGIBILITY.md",
        "poke-sim/docs/CHAMPIONS_FULL_SOURCE_INVENTORY_2026-08-29.md",
        "poke-sim/reports/reg_m_c_readiness_2026-09-07.md"
      ]
    },
    {
      "id": "database-evidence",
      "title": "Database And Evidence Integrity",
      "status": "blocked",
      "owner": "Database Engineer and human production operator",
      "legacy": [
        "M8",
        "M9"
      ],
      ...
      "evidence": [
        "docs/release/SUPABASE_FULL_AUDIT_2026-08-29.md",
        "docs/release/PROJECT_CLEANUP_AUDIT_2026-08-30.md"
      ]
    },
    {
      "id": "release-alignment",
      "title": "Reviewed Release And Repo Alignment",
      "status": "blocked",
      "owner": "Release Engineer and repository owners",
      "legacy": [
        "M6",
        "M7",
        "M10"
      ...
      "evidence": [
        "STATUS.md",
        "docs/release/PROJECT_CLEANUP_AUDIT_2026-08-30.md",
        "docs/release/GITHUB_QUEUE_RECONCILIATION_2026-08-30.md"
      ]
    },
    {
      "id": "homepage-news",
      "title": "News And Tournament Reference Coverage",
      "status": "local_only",
      "owner": "Source/Data Engineer and Release Engineer",
      "legacy": [
        "M6"
      ],
      "depends_on": [],
      ...
      "evidence": [
        "docs/release/HOMEPAGE_NEWS_REFRESH_2026-08-30.md",
        "poke-sim/reports/worlds_top_cut_validation_2026-08-30.md"
      ]
    },
    {
      "id": "beginner-experience",
      "title": "Beginner Homepage And Navigation Audit",
      "status": "queued",
      "owner": "UI Engineer, product owner and real beginner participants",
      "legacy": [
        "M6",
        "M10"
      ],
      ...
      "evidence": [
        "docs/strategy/BEGINNER_HOMEPAGE_AUDIT_PLAN.md",
        "docs/release/SITE_QUICK_WINS_2026-08-30.md",
        "docs/release/PLAYER_TRUST_AND_JOURNEY_AUDIT_2026-08-30.md"
      ]
    },
    {
      "id": "evidence-brain",
      "title": "Evidence-Backed No-API Brain",
      "status": "deferred",
      "owner": "Evidence/Brain Engineer and independent evidence reviewer",
      "legacy": [
        "M2",
        "M3"
      ],
      ...
      "evidence": [
        "docs/architecture/llm-brain-context.md",
        "docs/architecture/llm-brain-integration-audit.md",
        "poke-sim/docs/LEARNING_BRAIN_ARCHITECTURE_ROADMAP_2026-07-04.md"
      ]
    },
    {
      "id": "future-product",
      "title": "Optional Product Expansion",
      "status": "deferred",
      "owner": "Product owner after measured adoption and trust",
      "legacy": [
        "M4",
        "M5",
        "M11"
      ...
      "evidence": [
        "docs/archive/ROADMAP_PRE_CONSOLIDATION_2026-08-30.md"
      ]
    }
  ],
  "status_labels": {
