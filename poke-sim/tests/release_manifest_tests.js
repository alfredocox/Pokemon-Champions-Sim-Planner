...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.49-qa-artifact-evidence-intake', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v181-qa-artifact-evidence-intake', 'cache id mismatch');
