...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.98-github-release-guard', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v2-2-98-github-release-guard', 'cache id mismatch');
