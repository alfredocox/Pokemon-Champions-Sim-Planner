...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.48-overview-milestone-board', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v180-overview-milestone-board', 'cache id mismatch');
