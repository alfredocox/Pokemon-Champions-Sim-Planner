...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.51-team-lab-milestone-align', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v183-team-lab-milestone-align', 'cache id mismatch');
