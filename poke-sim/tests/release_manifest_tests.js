...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.36-bundle-sha-proof', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v168-bundle-sha-proof', 'cache id mismatch');
