...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.44-source-confidence-intake', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v176-source-confidence-intake', 'cache id mismatch');
