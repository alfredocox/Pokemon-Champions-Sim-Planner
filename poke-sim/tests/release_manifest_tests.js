...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.50-sim-evidence-adapter', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v182-sim-evidence-adapter', 'cache id mismatch');
