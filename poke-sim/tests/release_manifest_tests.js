...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.46-source-truth-packages', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v178-source-truth-packages', 'cache id mismatch');
