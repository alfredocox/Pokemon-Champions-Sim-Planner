...
T('1. manifest exposes canonical build and cache identity', () => {
  ...
  truthy(manifest.build_id === 'v2.2.37-public-security-guard', 'build id mismatch');
  truthy(manifest.service_worker_cache === 'champions-sim-v169-public-security-guard', 'cache id mismatch');
